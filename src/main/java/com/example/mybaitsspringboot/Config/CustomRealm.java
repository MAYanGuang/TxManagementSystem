...
public class CustomRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        //得到该用户所有角色名称
        Set<String> roles = roleDao.selectRoleNamesByUserId(user.getUserId());
        //得到该用户所有权限
        //此处一层子查询
        Set<String> authorityNames = authorityDao.selectAuthorityNameByRoleId(roleDao.selectRoleIdsByUserId(user.getUserId()));
        //授权对象
